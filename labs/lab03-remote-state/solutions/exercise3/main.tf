...
# Configure terraform remote state to retrieve state data from the bucket we created in previous exercises
...
output "ec2_instance_exercise2_id" {
    ...
    value       = data.terraform_remote_state.ec2_instance_exercise2.outputs.id
}

output "ec2_instance_exercise2_arn" {
    description = "ARN of EC2 instance provisioned in exercise 2"
    value       = data.terraform_remote_state.ec2_instance_exercise2.outputs.arn
}

output "ec2_instance_exercise2_public_ip" {
    description = "Public IP address of EC2 instance provisioned in exercise 2"
    value       = data.terraform_remote_state.ec2_instance_exercise2.outputs.public_ip
}
...
output "ec2_instance_exercise2_all_attributes" {
    ...
    value       = data.terraform_remote_state.ec2_instance_exercise2.outputs
}
